...
export const Courses = () => {
  ...
  const options = ['Introduction to Finance', 'Introduction to Financial Concepts', 'Interest Rates', 'Saving and expenditure', 'Risk and Return', 'Risk diversification', 'Stock', 'Bond', 'Mutual Funds', 'Real Estate'];
  ...
  const handleOptionClick = (option) => {
    ...
    const lastSelectedIndex = options.indexOf(selectedOptions[selectedOptions.length - 1]);
...
></iframe> */}
        ...
        <iframe className='custom-iframe' width="700" height="415" src="https://www.youtube.com/embed/4j2emMn7UaI?si=ODR72EYRVBeIJnEf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
Throughout the course, you will explore essential financial concepts and their applications in real-world scenarios. From the basics of budgeting and saving to the complexities of investment analysis and risk management, you will gain the necessary tools and insights to make informed financial decisions.</p>
        ...
        <Col lg={4} offset-lg={1} className="p-0 overflow-hidden shadow-lg">
          <img className="rounded-lg-3" src="https://www.topuniversities.com/sites/default/files/styles/articles_inline/public/articles/lead-images/finance_2.jpg.webp" alt="" width="720" />
        </Col>
      </Row>
    </Container>
        </div>;
      ...
      >
        ...
        <p>Unlock the fundamentals of financial concepts and gain the knowledge to make informed decisions in personal and professional financial matters</p>
      </MDBCarouselItem>
      ...
      >
        ...
        <p>Explore the dynamics of borrowing and lending, and delve into the impact of interest rates on economies, investments, and personal finance decisions</p>
      </MDBCarouselItem>
      ...
      >
        ...
        <p>Master the art of balancing your finances by understanding effective saving strategies and smart expenditure practices for a secure financial future</p>
      </MDBCarouselItem>
      ...
      >
        ...
        <p>Navigate the intricate relationship between risk and reward, gaining insights into investment decisions and strategies that maximize returns while managing potential risks effectively</p>
      </MDBCarouselItem>
...
<Col lg={4} offset-lg={1} className="p-0 overflow-hidden shadow-lg">
  <img className="rounded-lg-3" src="https://www.topuniversities.com/sites/default/files/styles/articles_inline/public/articles/lead-images/finance_2.jpg.webp" alt="" width="720" />
    ...
    case 'Saving and expenditure':
        content = <div><iframe className='custom-iframe' width="700" height="415" src="https://www.youtube.com/embed/4j2emMn7UaI?si=ODR72EYRVBeIJnEf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            ...
            <ul className="nav flex-column">
              {options.map((option) => (
                <li key={option} className="nav-item">
                  <button
                    className={`nav-link ${selectedOptions.includes(option) ? 'active' : ''}`}
                    onClick={() => handleOptionClick(option)}
                    disabled={!selectedOptions.includes(option) && selectedOptions.length !== options.indexOf(option)}
                  >
                    {option}
                  </button>
                </li>
